    ...
    return (
        <>
            <Box flex={1} alignItems={'center'}>
                <Box maxW={'400px'} flex={1} safeArea px={step === 5 ? 0 : 4} py={4}>
                    <Box px={step === 5 ? 4 : 0}>
                        <Box>
                    ...
                    <Box p={2} flex={1} alignItems={'center'} justifyContent={'center'}>
                        ...
                        {step === 5 && (
                            <Box flex={1} w={'100%'}>
                                {pick > 1 && (
                                    <Text m={2} mt={0} fontFamily={'Arch'} fontWeight={500} fontSize={'14px'} color={'blue.100'}>
                                        {BookStatusCase(pick)}
                                    </Text>
                                )}
