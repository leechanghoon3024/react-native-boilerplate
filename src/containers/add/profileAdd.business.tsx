...
import { dateFormat, dateFormatDays2, dateFormatNotTime } from '../../utils/times';
...
const ProfileAddBusiness = () => {
    ...
    console.log('user?.businessType', values?.businessType);
    return (
        <Box bg={'white.100'}>
                            ...
                            <VStack my={8} space={'8'} mb={18}>
                                ...
                                >
                                    <Box w={'100%'} p={1} pb={0} justifyContent={'center'} alignItems={'center'}>
                                        <DefaultDown
                                            value={values?.businessType === '0' ? 5 : values?.businessType}
...
export default ProfileAddBusiness;
