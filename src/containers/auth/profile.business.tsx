...
import { Box, Button, Flex, Heading, HStack, Input, KeyboardAvoidingView, ScrollView, Text, useToast, VStack } from 'native-base';
...
import { TransactionBagCase, TransactionBusinessCase, TransactionBusinessCase2 } from '../../etc/bookStatusCase';
import Toast from 'react-native-toast-message';

const ProfileSchema = Yup.object().shape({
    businessName: Yup.string().required(`Please enter your Name of organisation`),
    businessType: Yup.string().required(`Please enter your Type of organisation`),
    abn: Yup.string().required(`Please enter your ABN of organisation`),
...
const BusinessProfile = () => {
    ...
    const profileUpdate = async (value: any) => {
        try {
            const api = await axiosService.post('/users/app/business/update', value);
    ...
    return (
        <Box bg={'white.100'}>
            <Box safeAreaTop mt={4} px={'18px'} bg={'white.100'}>
                        ...
                        {edit ? (
                            <VStack my={8} space={'8'} mb={18}>
                                ...
                                <Box
                                    ...
                                    px={2}
                                >
                                    <Box w={'100%'} p={1} pb={0} justifyContent={'center'} alignItems={'center'}>
                                        <DefaultDown
                                        ...
                                        />
                                        <Box px={2} position={'absolute'} left={3} top={-14} bg={'white.100'}>
